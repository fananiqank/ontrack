...
class User extends App {
    ...
    public static function assigntsuser($data) {
        ...
        $selped = $database->query("select a.*,b.email from people_dtl_request a join people b on a.peopleid=b.id where a.id = '$_POST[peopledtlid]'");
    ...
    SUBSTRING_INDEX(ticket,'/',-2) desc limit 1");
        ...
        //$emailreported = getSingleValue("people","email",$_POST['peopleid']);
        
        $noticket= "IT"."/".$thn."".$bln."".$tg."/".sprintf("%03s", $noUrutj);
        $data3 = array('ticket' =>  $noticket,
                            'departmentid' => 1,
                            'clientid' => 6,
                            'userid' => $saped['peopleid'],
        ...
        //die();
            ...
            include "./phpmailer/pushemailassignts.php";
