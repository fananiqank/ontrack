...
if (empty($_GET['route'])) $route = "dashboard&th=".date("Y"); else $route = $_GET['route'];
...
// echo $scriptpath . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'controllers' . DIRECTORY_SEPARATOR . 'actions.php';
