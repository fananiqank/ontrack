...
$con=new Database();
		...
		//email ke TS (SPV)	   
				if ($email['email'] != ''){
					...
					$mail->Subject = 'Reminder Target Time Ticket No. '.$tclose['ticket'].' : '.$tclose['status'];
					//Read an HTML message body from an external file, convert referenced images to embedded,
					
						$text="<p>Hello IT Team,<br><br>
								There's outstanding ticket ".$tclose['ticket']." which need your help. <br> 
								if the status has finished please update ticket status to finish ticket.<br><br>
								Please update ticket task in <a href='http://192.168.31.25/ontrack'>Erassets</a>
								<br><br>regards, <br>
