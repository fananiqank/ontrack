...
where b.id = '$data[peopledtlid2]' ORDER BY b.id DESC) a","*","") as $dpt){}
	...
	//email ke PIC IT blast email
		foreach($con->select("tickets","ticket,adminid","people_dtl_request_id = '$data[peopledtlid2]'") as $notiket){
            ...
            foreach($expem as $key => $value){
	            ...
	            if ($pemail['email'] != ''){
					...
					$text = "<p>Hello IT Team,<br><br>A new ticket has been created for your task.<br>Ticket ID: <b>".$notiket['ticket']."</b><br><br> 
				            ...
				            View Form Request Follow this <a href='http://192.168.31.25/eraticket/cetak.php?page=$ctk&id=$data[peopledtlid2]'>Link</a>
        		...
        		if ($is['email'] != ''){
					...
					//Read an HTML message body from an external file, convert referenced images to embedded,
	                    ...
	                    <br>
	                     ...
	                     <br>
	                    <br>
	                    View Progress Request Follow this <a href='http://192.168.31.25/eraticket/index.php?x=viewnewreq&d=$data[peopledtlid2]'>Link</a>
	                        <br>
	                        <br>
	                        regards, <br>
